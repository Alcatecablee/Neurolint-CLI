...
Backup available: neurolint restore --interactive`}
      ...
      <section className="mb-12">
        ...
        <Callout type="success" title="Cross-Session Learning">
          Running individual layers now contributes to Layer 7's learning! Each layer run 
          logs transformations to <code className="text-white">.neurolint/transformation-log.json</code>. 
          When you run Layer 7 later, it automatically learns from these previous transformations 
          across sessions.
        </Callout>
      </section>
